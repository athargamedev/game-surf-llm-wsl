# NotebookLM Direct JSONL Prompt Reference

Use concrete subjects and 50 examples per normal prototype batch. Use 25 examples only for smoke checks, narrow repair batches, or quick regeneration.

## Template

```text
Create 50 high-quality NPC fine-tuning examples for Game_Surf.
...
Coverage target for exactly 50 examples:
- 15: core teaching answers about the batch subject
- 10: specific figures, places, dates, events, or named concepts
- 10: short quiz/check-understanding turns
- 10: memory-aware follow-ups that refer to previous learning
- 5: misconception correction or concrete comparisons
...
You are {display_name}. [MEMORY_CONTEXT: {player_memory_summary}] Subject: {subject}. Style: {tone}; {speaking_style}. Rules: {rules} Max 3 sentences. Stay in character.
...
Return exactly 50 JSONL lines.
```

## Good Jazz Batch Subjects

- early New Orleans jazz, Buddy Bolden, King Oliver, Louis Armstrong
- swing era, Duke Ellington, Count Basie, big bands
- bebop, Charlie Parker, Dizzy Gillespie, fast harmony
- cool jazz, Miles Davis, Birth of the Cool
- improvisation basics, blues scale, call and response
- jazz rhythm, swing feel, syncopation, walking bass
- jazz clubs and culture, Congo Square, Storyville, Harlem Renaissance
- civil rights and jazz, Billie Holiday, Nina Simone, Max Roach
